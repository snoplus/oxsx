...
void EventReconvolution::SetCorrection(double correction_)
{
    if (correction_ < 0)
...
void EventReconvolution::SetParameter(const std::string &name_, double value)
{
    if (name_ != fParamName)
...
void EventReconvolution::SetParameters(const ParameterDict &pd_)
{
    try
    {
...
void EventReconvolution::RenameParameter(const std::string &old_, const std::string &new_)
{
    if (old_ != fParamName)
...
void EventReconvolution::SetName(const std::string &name_)
{
    fName = name_;
}
