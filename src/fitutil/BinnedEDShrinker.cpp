...
void BinnedEDShrinker::SetBuffer(const std::string &obs_, unsigned lowerBuff_, unsigned upperBuff_)
{
...
void BinnedEDShrinker::SetBinMap(const BinnedED &dist_)
{
...
void BinnedEDShrinker::SetUsingOverflows(bool b_)
{
  fUsingOverflows = b_;
}

bool BinnedEDShrinker::GetUsingOverflows() const
{
