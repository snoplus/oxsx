...
void EDManager::AddDist(EventDistribution *pdf_)
{
    if (!fDists.size())
...
void EDManager::AddDists(const std::vector<EventDistribution *> &pdfs_)
{
...
void EDManager::SetNormalisations(const std::vector<double> &norms_)
{
...
void EDManager::RegisterParameters()
{
...
void EDManager::SetName(const std::string &n_)
{
    fName = n_;
}

void EDManager::RenameParameter(const std::string &old_, const std::string &new_)
{
    fParameterManager.RenameParameter(old_, new_);
}

void EDManager::SetParameter(const std::string &name_, double value_)
{
...
void EDManager::SetParameters(const ParameterDict &ps_)
{
