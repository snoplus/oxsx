...
void Gaussian::Initialise(const std::vector<double> &means_, const std::vector<double> &stdDevs_,
...
void Gaussian::SetMean(const size_t &dim_, const double &value_)
{
    fMeans[dim_] = value_;
}

void Gaussian::SetStDev(const size_t &dim_, const double &value_)
{
...
void Gaussian::SetStDevs(const std::vector<double> &stddevs_)
{
    fStdDevs = stddevs_;
}
...
void Gaussian::SetMeansStdDevs(const std::vector<double> &means_,
...
void Gaussian::SetCdfCutOff(double cutOff_)
{
    fCdfCutOff = cutOff_;
}
...
// Make it fittable   //
////////////////////////
void Gaussian::RenameParameter(const std::string &old_, const std::string &new_)
{
    fFitter.RenameParameter(old_, new_);
}

void Gaussian::SetParameter(const std::string &name_, double value_)
{
...
void Gaussian::SetParameters(const ParameterDict &ps_)
{
...
void Gaussian::SetName(const std::string &name_)
{
    fName = name_;
}
