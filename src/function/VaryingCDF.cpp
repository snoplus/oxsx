...
void VaryingCDF::SetDependance(const std::string &paraName_, const Function *func_)
{
...
void VaryingCDF::SetKernel(ConditionalPDF *PDF_)
{
    fCdf = PDF_->Clone();
}

void VaryingCDF::SetKernel(PDF *PDF_)
{
...
void VaryingCDF::SetParameter(const std::string &name_, double value_)
{
...
void VaryingCDF::SetParameters(const ParameterDict &paraDict_)
{
...
void VaryingCDF::RenameParameter(const std::string &old_, const std::string &new_)
{
    for (std::map<std::string, Function *>::const_iterator function = fFunctions.begin(); function != fFunctions.end(); ++function)
    {
...
void VaryingCDF::SetName(const std::string &name_)
{
    fName = name_;
}
