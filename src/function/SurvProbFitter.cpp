...
SurvProbFitter::RenameParameter(const std::string& old_, const std::string& new_){
    ...
    if(find(fDelmsqr21sNames.begin(),fDelmsqr21sNames.end(),old_)==fDelmsqr21sNames.end() && find(fSinsqrtheta12sNames.begin(),fSinsqrtheta12sNames.end(),old_)==fSinsqrtheta12sNames.end() && find(fSinsqrtheta13sNames.begin(),fSinsqrtheta13sNames.end(),old_)==fSinsqrtheta13sNames.end())
