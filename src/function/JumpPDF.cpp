...
void JumpPDF::SetName(const std::string &name)
{
  fName = name;
}
void JumpPDF::RenameParameter(const std::string &old_, const std::string &new_)
{
  if (!fPDF)
    throw NULLPointerAccessError("JumpPDF::Probability",
                                 "Have you set the function?");
...
void JumpPDF::SetParameter(const std::string &name_, double value_)
{
  if (!fPDF)
    throw NULLPointerAccessError("JumpPDF::Probability",
                                 "Have you set the function?");
...
void JumpPDF::SetParameters(const ParameterDict &ps_)
{
  if (!fPDF)
    throw NULLPointerAccessError("JumpPDF::Probability",
                                 "Have you set the function?");
