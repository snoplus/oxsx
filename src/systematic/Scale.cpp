...
void Scale::SetParameter(const std::string &name_, double value)
{
    if (name_ != fParamName)
...
void Scale::SetParameters(const ParameterDict &pd_)
{
    try
    {
...
void Scale::RenameParameter(const std::string &old_, const std::string &new_)
{
    if (old_ != fParamName)
...
void Scale::SetName(const std::string &name_)
{
    fName = name_;
}
