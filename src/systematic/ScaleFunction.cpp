...
void ScaleFunction::SetParameter(const std::string &name_, double value)
{
...
void ScaleFunction::SetParameters(const ParameterDict &pd_)
{
    for (auto &&pair : pd_)
    {
        try
...
void ScaleFunction::RenameParameter(const std::string &old_, const std::string &new_)
{
...
void ScaleFunction::CacheBinMapping()
{
    /*
