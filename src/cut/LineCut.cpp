...
Cut *LineCut::Clone() const
{
    return new LineCut(*this);
}

bool LineCut::PassesCut(const Event &ev_) const
{
    double val = 0;
    try
    {
...
void LineCut::SetCutValue(double val_)
{
    fVal = val_;
}
...
void LineCut::SetSidedness(const std::string &side_)
{
