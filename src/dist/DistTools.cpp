...
TH1D DistTools::ToTH1D(const BinnedED &pdf_, const bool widthCorrect_)
{
    if (pdf_.GetNDims() != 1)
...
TH1D DistTools::ToTH1D(const Histogram &histo_, const bool widthCorrect_)
{
...
TH2D DistTools::ToTH2D(const Histogram &histo_)
{
...
TH2D DistTools::ToTH2D(const BinnedED &pdf_)
{
    if (pdf_.GetNDims() != 2)
        throw DimensionError("Only a 2D pdf can be represented by a TH2D");
...
TH3D DistTools::ToTH3D(const Histogram &histo_)
{
...
TH3D DistTools::ToTH3D(const BinnedED &pdf_)
{
    if (pdf_.GetNDims() != 3)
        throw DimensionError("Only a 3D pdf can be represented by a TH3D");
