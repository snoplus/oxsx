...
void BinnedED::SetObservables(const std::vector<std::string> &rep_)
{
...
void BinnedED::SetHistogram(const Histogram &hist_)
{
    fHistogram = hist_;
}

void BinnedED::Fill(const Event &data_, double weight_)
{
    try
    {
...
void BinnedED::SetName(const std::string &name_)
{
    fName = name_;
}
...
void BinnedED::SetAxes(const AxisCollection &axes_)
{
    fHistogram.SetAxes(axes_);
}
...
BinnedED::Probability(const Event &oberservations_) const
{
    ...
    {
        throw RepresentationError("BinnedED::Probability() failed with  " + std::string(e_.what()) + " is the rep set correctly?");
    }
}
...
void BinnedED::Normalise()
{
    fHistogram.Normalise();
}

void BinnedED::Scale(double s_)
{
    fHistogram.Scale(s_);
}

void BinnedED::Fill(const std::vector<double> &vals_, double weight_)
{
    fHistogram.Fill(vals_, weight_);
}

void BinnedED::Fill(double vals_, double weight_)
{
    fHistogram.Fill(vals_, weight_);
}
...
void BinnedED::AddBinContent(size_t bin_, double content_)
{
    fHistogram.AddBinContent(bin_, content_);
}

void BinnedED::SetBinContent(size_t bin_, double content_)
{
...
void BinnedED::SetBinContents(const std::vector<double> &data_)
{
...
void BinnedED::Add(const BinnedED &other_, double weight)
{
...
void BinnedED::Multiply(const BinnedED &other_)
{
    if (other_.fObservables != fObservables)
...
void BinnedED::Divide(const BinnedED &other_)
{
    if (other_.fObservables != fObservables)
...
void BinnedED::AddPadding(double padding_)
{
