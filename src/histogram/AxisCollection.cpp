...
void AxisCollection::AddAxis(const BinAxis &axis_)
{
...
void AxisCollection::AddAxes(const std::vector<BinAxis> &axes_)
{
...
void AxisCollection::GetBinLowEdges(size_t bin_, std::vector<double> &output_) const
{
...
void AxisCollection::GetBinHighEdges(size_t bin_, std::vector<double> &output_) const
{
...
void AxisCollection::GetBinCentres(size_t bin_, std::vector<double> &output_) const
{
    if (bin_ > fNBins)
        throw NotFoundError(Formatter() << "GetBinHighEdges on bin "
                                        << bin_
...
bool AxisCollection::operator==(const AxisCollection &other_) const
{
