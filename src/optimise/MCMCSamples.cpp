...
void MCMCSamples::SetSaveFullHistogram(bool b_)
{
    fSaveFullHistogram = b_;
}

bool MCMCSamples::GetSaveFullHistogram() const
{
    return fSaveFullHistogram;
}

bool MCMCSamples::GetSaveChain() const
{
    return fSaveChain;
}

void MCMCSamples::SetSaveChain(bool b_)
{
    fSaveChain = b_;
}
...
void MCMCSamples::SetHistogramAxes(const AxisCollection &ax_)
{
    fHistogramAxes = ax_;
}
AxisCollection
...
void MCMCSamples::InitialiseHistograms()
{
...
void MCMCSamples::Fill(const ParameterDict &params_, double val_, bool accepted_)
{
    if (!fInitialised)
...
int MCMCSamples::GetBurnIn() const
{
    return fBurnIn;
}

void MCMCSamples::SetBurnIn(int b_)
{
    fBurnIn = b_;
}

int MCMCSamples::GetThinFactor() const
{
    return fThinFactor;
}

void MCMCSamples::SetThinFactor(int tf_)
{
    fThinFactor = tf_;
}

void MCMCSamples::Clear()
{
    fAcceptedSteps = 0;
    fTotalSteps = 0;
    fSample.clear();
