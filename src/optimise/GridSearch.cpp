...
void GridSearch::SetMinima(const ParameterDict &minima_)
{
    fMinima = minima_;
}

void GridSearch::SetMaxima(const ParameterDict &maxima_)
{
    fMaxima = maxima_;
}

void GridSearch::SetStepSizes(const ParameterDict &steps_)
{
    fStepSizes = steps_;
}
...
GridSearch::Optimise(TestStatistic *testStat_)
{
    ...
    if (!HasSameKeys(fStepSizes, fMaxima) || !HasSameKeys(fStepSizes, fMinima))
...
bool GridSearch::Increment(ParameterDict::iterator it_,
...
bool GridSearch::GetMaximising() const
{
    return fMaximising;
}

void GridSearch::SetMaximising(bool b_)
{
    fMaximising = b_;
}
