...
void Minuit::SetMethod(const std::string &method_)
{
    fMethod = method_;
}
...
void Minuit::SetInitialErrors(const ParameterDict &errs_)
{
    fInitialErrors = errs_;
}

void Minuit::SetInitialValues(const ParameterDict &vals_)
{
    fInitialValues = vals_;
}

void Minuit::SetUpperContourEdge(double val_)
{
...
void Minuit::SetMaxima(const ParameterDict &maxima_) { fMaxima = maxima_; }

ParameterDict
Minuit::GetMaxima() const { return fMaxima; }

void Minuit::SetMinima(const ParameterDict &minima_) { fMinima = minima_; }

ParameterDict
Minuit::GetMinima() const { return fMinima; }

void Minuit::Initialise(TestStatistic *testStat_)
{
    delete fMinimiser;
    fMinimiser = NULL;
...
void Minuit::Fix(const std::string &name_)
{
    fFixedParameters.insert(name_);
}

void Minuit::Release(const std::string &name_)
{
    fFixedParameters.erase(name_);
}

void Minuit::SetMaxCalls(unsigned max_)
{
    fMaxCalls = max_;
}
...
void Minuit::SetTolerance(double tol_)
{
    fTolerance = tol_;
}
