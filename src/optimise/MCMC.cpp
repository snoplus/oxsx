...
void MCMC::SetHistogramAxes(const AxisCollection &ax_)
{
...
void MCMC::SetBurnIn(unsigned burnIn_)
{
...
void MCMC::SetThinFactor(unsigned thinFac_)
{
...
void MCMC::SetMaxIter(unsigned maxIter_)
{
    fMaxIter = maxIter_;
}
...
void MCMC::SetMinima(const ParameterDict &minima_)
{
    fMinima = minima_;
}
...
void MCMC::SetMaxima(const ParameterDict &maxima_)
{
    fMaxima = maxima_;
}

void MCMC::SetFlipSign(bool b_)
{
    fFlipSign = b_;
}

bool MCMC::GetFlipSign() const
{
    return fFlipSign;
}

bool MCMC::GetTestStatLogged() const
{
    return fTestStatLogged;
}

void MCMC::SetTestStatLogged(bool b_)
{
    fTestStatLogged = b_;
}

bool MCMC::GetSaveFullHistogram() const
{
    return fSamples.GetSaveFullHistogram();
}

void MCMC::SetSaveFullHistogram(bool b_)
{
    fSamples.SetSaveFullHistogram(b_);
}

bool MCMC::GetSaveChain() const
{
    return fSaveChain;
}

void MCMC::SetSaveChain(bool b_)
{
    fSaveChain = b_;
...
MCMC::Optimise(TestStatistic *testStat_)
{
    ...
    if ((fInitialTrial.size() != nParams && fInitialTrial.size()) || fMaxima.size() != nParams || fMinima.size() != nParams)
