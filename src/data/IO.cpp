...
void IO::SaveDataSet(const DataSet &dataSet_, const std::string &filename_, const std::string &treename_)
{
...
void IO::SaveDataSetROOT(const DataSet &dataSet_, const std::string &filename_, const std::string &treename_)
{
...
void IO::SaveDataSetH5(const DataSet &dataSet_, const std::string &filename_)
{
...
void IO::SaveHistogram(const Histogram &hist_, const std::string &filename_, const std::string &histname_)
{
    std::string ext = GetExt(filename_);
    if (ext == "h5")
...
void IO::SaveHistogramROOT(const Histogram &hist_, const std::string &filename_, const std::string &histname_)
{
...
void IO::SaveHistogramH5(const Histogram &histo_, const std::string &fileName_)
{
