...
Event ROOTTree::Assemble(size_t iEvent_) const
{
...
Event ROOTTree::GetEntry(size_t iEvent_) const
{
    return Assemble(iEvent_);
}

void ROOTTree::GatherObservableNames()
{
