...
void DataSetGenerator::SetCuts(const CutCollection &cuts_)
{
  fCuts = cuts_;
}

void DataSetGenerator::AddCut(const Cut &cut_)
{
  fCuts.AddCut(cut_);
}

void DataSetGenerator::SetDataSets(const std::vector<DataSet *> sets_)
{
  fDataSets = sets_;
...
void DataSetGenerator::SetExpectedRates(const std::vector<double> &rates_)
{
...
void DataSetGenerator::RandomDrawsNoReplacement(size_t handleIndex_, size_t nEvents_,
...
void DataSetGenerator::RandomDrawsWithReplacement(size_t handleIndex_, size_t nEvents_,
                                                  OXSXDataSet &outData_)
{
...
void DataSetGenerator::AddDataSet(DataSet *data_, double rate_, bool flag_)
{
...
void DataSetGenerator::SetBootstrap(const std::vector<bool> &b_)
{
  fBootstraps = b_;
}

void DataSetGenerator::ClearDataSets()
{
...
void DataSetGenerator::SequentialDrawsNoReplacement(size_t handleIndex_, size_t nEvents_, OXSXDataSet &data_)
{
  std::vector<size_t> &eventIndices = fEventIndicies[handleIndex_];
  size_t &max = fMaxs[handleIndex_];
  DataSet *origData = fDataSets.at(handleIndex_);
...
void DataSetGenerator::SetSequentialFlags(const std::vector<bool> &flags_)
{
