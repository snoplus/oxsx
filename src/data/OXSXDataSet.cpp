...
#include <iostream>
void OXSXDataSet::AddEntry(const Event &evData_)
{
...
Event OXSXDataSet::GetEntry(size_t eventIndex_) const
{
    try
    {
...
void OXSXDataSet::SetObservableNames(const std::vector<std::string> &names_)
{
...
void OXSXDataSet::Reserve(int i)
{
    fData.reserve(i);
}
