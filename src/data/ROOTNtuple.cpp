...
Event ROOTNtuple::Assemble(size_t iEvent_) const
{
...
Event ROOTNtuple::GetEntry(size_t iEvent_) const
{
    return Assemble(iEvent_);
}

void ROOTNtuple::GatherObservableNames()
{
