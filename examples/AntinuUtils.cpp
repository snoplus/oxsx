...
void readConstraintsInfoFile(const std::string &runConstraintsInfoFileName, std::string reactor_name, Double_t &fit_mean, Double_t &fit_mean_err, Double_t &fit_sigma, Double_t &fit_sigma_err ) {
    //
    // Read constraints info text file - generated by the 'passes_plot' script which fits number of events per year per reactor
    //
...
BinnedED LHFit_initialise(BinnedED **spectra_pdf, const std::string &in_path, const std::string &data_path, ULong64_t flux_data){
    //
