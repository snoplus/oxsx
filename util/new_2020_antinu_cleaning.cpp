...
Int_t main(Int_t argc, char *argv[]) {
    ...
    if (argc != 13) {
        std::cout<<"Error: 12 arguments expected. Got: "<<argc-1<<std::endl;
        ...
        fclose(fOut);
        process_cuts(filename_input, filename_output, Rmax, Zmax, Zmin, energy_ep_min, energy_ep_max, energy_n_min, energy_n_max, deltaTmin, deltaTmax, deltaRmax);
